...
class ControllerFeedIdealoCSV extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['idealo_csv_store_id'])) {
			$data['idealo_csv_store_id'] = $this->request->post['idealo_csv_store_id'];
		} else {
			$data['idealo_csv_store_id'] = $this->config->get('idealo_csv_store_id');
		}
